...
async function renderInfo() {
    ...
    (0, _chartsJsDefault.default).renderChartTemp(tempValue);
    (0, _chartsJsDefault.default).renderChartHumi(humiValue);
}

},{"./charts.js":"kkiZQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kkiZQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
let myChartTemp = new (0, _autoDefault.default)(ctxTemp, {
    type: "bar",
    data: {
        labels: [
            "temperature \xb0C"
...
let myChartHumi = new (0, _autoDefault.default)(ctxHumi, {
    type: "bar",
    data: {
        labels: [
            "humidity %"
...
},{}]},["iWvxK","bNKaB"], "bNKaB", "parcelRequireac8b")
